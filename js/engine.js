...
var Engine = (function (global) {
    ...
    document.body.insertBefore(newTag, canvas);
    ...
    function main() {
         ...
         */
        if (gameStop < 1) {
            reqAnim = win.requestAnimationFrame(main);
        }
        else {
            win.cancelAnimationFrame(reqAnim);
        }
    ...
    function start() {
        ...
        win.count = 10000;
        win.startVelocityNumber = 2;
        win.life = 3;
        win.player.x = canvas.width / 2;
        win.player.y = 420;
